...
tasks = [
    Task(description="Use FileReadTool para ler relatorio_codebase_turbinado.md. Analise arquitetura e sugira melhorias.",
         expected_output="Parágrafo com análise arquitetural clara e recomendações.",
         agent=agents["arquiteto"]),
    Task(description="Leia o relatório. Avalie qualidade de código e cobertura de testes.",
         expected_output="Comentários e recomendações sobre qualidade e testes.",
         agent=agents["qa_engineer"]),
    Task(description="Leia o relatório. Avalie documentação existente e proponha melhorias.",
         expected_output="Resumo dos pontos fortes e lacunas da documentação.",
         agent=agents["documentador"]),
    Task(description="Leia o relatório. Avalie maturidade do produto para SaaS e proponha roadmap.",
         expected_output="Avaliação de readiness e proposta de roadmap.",
         agent=agents["pm"]),
    Task(description="Leia o relatório. Analise riscos legais e conformidade.",
         expected_output="Análise de riscos legais e sugestões de compliance.",
         agent=agents["legal"]),
    Task(description="Leia o relatório. Analise o componente IA e sugira otimizações.",
