# Análise do arquivo: main.py

❌ Erro ao analisar /Volumes/SSD-EXTERNO/2025/CrewAvaliadora/main.py: litellm.APIConnectionError: Your default credentials were not found. To set up Application Default Credentials, see https://cloud.google.com/docs/authentication/external/set-up-adc for more information.
